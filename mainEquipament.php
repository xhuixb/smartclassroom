...
<html>
    ...
    <body onload="controlaCredencials('dadesProfEquipament');carregaEquipament(0);">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-1">
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#agrupacioPrestecs"><span class="glyphicon glyphicon-list-alt"></span> Estadístiques</button>
                </div>
            </div>
        </div>
