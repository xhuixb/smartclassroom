...
echo '<button data-tipusgrup="" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" id="butDropdivGrupHorari">Tria grup<span class="caret"></span></button>';
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<li><a data-tipusgrup="0" data-val="' . $row['codi'] . '" onclick="mostradivGrupHorari(this);">' . $row['descripcio'] . '</a></li>';
    }
}
...
if ($result1->num_rows > 0) {
    ...
    while ($row1 = $result1->fetch_assoc()) {
        ...
        echo '<li><a data-tipusgrup="1" data-nivell="'.$row1['nivell'].'" data-val="' . $row1['codi'] . '" onclick="mostradivGrupHorari(this);">' . $row1['descripcio'] . '</a></li>';
    }
}
