...
$query = "select ga04_codi_prof as codiprof,concat(ga04_cognom1,' ',ga04_cognom2,', ',ga04_nom) as nomcomplet, ga04_cognom1 as cognom1,ga04_cognom2 as cognom2,ga04_nom as nom,ga04_mail as mail,ga04_login as login,ga04_password as password,ga04_suspes as suspes from ga04_professors,ga17_professors_curs"
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr>';
        echo '<td class="col-sm-3" data-nom="' . $row['nom'] . '" data-codiprof="' . $row['codiprof'] . '" data-cognom1="' . $row['cognom1'] . '" data-cognom2="' . $row['cognom2'] . '" data-password="' . $row['password'] . '" data-suspes="'.$row['suspes'].'">' . $row['nomcomplet'] . '</td>';
        ...
        echo '<td class="col-sm-1"><button type="button" class="btn form-control btn-'.$situacioColor.'" onclick="situacioProfessor(this);" data-toggle="tooltip" title="canvia estat">'.$situacio;
        echo '</button></td>';
        echo '</tr>';
    }
    echo '</tbody>';
